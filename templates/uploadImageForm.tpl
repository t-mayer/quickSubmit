	 ...
	 {fbvFormArea id="coverImage" title="editor.issues.coverPage"}
		 ...
		 <div id="extraAltText"{if $coverImage} style="display:none"{/if}>
			 {fbvFormSection title="common.altText"}
				 {fbvElement type="text" label="common.altTextInstructions" id="altText" value=$altText}
			 {/fbvFormSection}
		 </div>
		 ...
		 {fbvFormSection id="coverImagePreview"}
			 ...
			 {if $coverImage != ''}
				<div class="pkp_form_file_view pkp_form_image_view">
					 <div class="img">
						 <img src="{$publicFilesDir}/{$coverImage[$currentLocale]['uploadName']}" {if $coverImageAlt !== ''} alt="{$coverImageAlt|escape}"{/if}>
					 </div>
					 ...
					 <div class="data">
						 ...
						 <span class="value">
							 {fbvElement type="text" id="altText" label="common.altTextInstructions" value=$altText}
						 </span>
