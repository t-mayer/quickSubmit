...
class QuickSubmitPlugin extends ImportExportPlugin {
	...
	public function register($category, $path, $mainContextId = NULL) {
		...
		// Load stylesheet for publication formats grid.
		$request = Application::get()->getRequest();
		$url = $request->getBaseUrl() . '/' . $this->getPluginPath() . '/styles/less/quickSubmitForm.less';
		$templateMgr = TemplateManager::getManager($request);
		$templateMgr->addStyleSheet('quickSubmitStyles', $url, [
			'contexts' => 'backend',
